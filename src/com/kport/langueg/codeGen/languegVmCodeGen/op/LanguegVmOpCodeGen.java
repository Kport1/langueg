...
public class LanguegVmOpCodeGen implements OpCodeGenSupplier{
    ...
    static {
        ...
        primitiveBinOps.put(new Pair<>(PrimitiveType.F32, TokenType.Eq), (binOp, state) -> state.writeOp(Ops.EQF32));
        primitiveBinOps.put(new Pair<>(PrimitiveType.F32, TokenType.NotEq), (binOp, state) -> state.writeOp(Ops.NOTEQF32));
        ...
        primitiveBinOps.put(new Pair<>(PrimitiveType.F64, TokenType.Eq), (binOp, state) -> state.writeOp(Ops.EQF64));
        primitiveBinOps.put(new Pair<>(PrimitiveType.F64, TokenType.NotEq), (binOp, state) -> state.writeOp(Ops.NOTEQF64));
    }
